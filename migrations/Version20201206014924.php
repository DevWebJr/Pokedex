 ...
 */
final class Version20201206014924 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE pokemon ADD family_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE pokemon ADD CONSTRAINT FK_62DC90F3C35E566A FOREIGN KEY (family_id) REFERENCES family (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_62DC90F3C35E566A ON pokemon');
